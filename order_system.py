def place_order(menu):
    ...
    print("Welcome to the Snack Stack Take Out Restaurant.")
...
def update_order(order, menu_selection, menu_items):
    ...
    if menu_selection.isdigit():
        ...
        if menu_number in menu_items:
            ...
            price = menu_items[menu_number]["Price"]


            # TODO: Ask the customer for the quantity of the menu item
            # TODO: Use the item name variable in the question
            quantity_input = input(f" what quantity of {item_name} would you like to order?:")
            ...
            if quantity_input.isdigit():
                ...
                if quantity <=0:
                    print("invalid quantity, cannot order 0 or less. Defaulting to 1.")
                    quantity = 1
            else:
                quantity = 1
